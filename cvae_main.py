...
if __name__ == "__main__":
    ...
    vae = CVAE(skip_features_start=2, num_skip_downsamplings=5, style_size=256).cuda()
    dataset = StyledImagesDataset("/home/argentumwalker/Projects/#DATA/deviantart")
    train_vae(vae, cl_encoder, dataset, dataloader_workers=6, batch_size=4, lr=5e-5, epochs=500, cos_loss_coef=-0.1)
